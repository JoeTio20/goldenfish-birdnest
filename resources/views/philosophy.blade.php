...
@media(max-width:767px){
  .phil-about-grid{grid-template-columns:1fr}
  .phil-pillars-grid{grid-template-columns:1fr}
}
</style>
@endsection
@section('content')

<section style="position:relative;height:55vh;min-height:320px;max-height:480px;display:flex;align-items:center;justify-content:center;overflow:hidden">
