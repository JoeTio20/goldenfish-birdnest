...
.feat-card{background:#fff;border-radius:12px;overflow:hidden;border:1px solid rgba(107,174,214,.15);transition:transform .25s,box-shadow .25s}
.feat-card:hover{transform:translateY(-4px);box-shadow:0 14px 32px rgba(13,27,42,.1)}
...
<section style="position:relative;min-height:100vh;display:flex;align-items:center;justify-content:center;overflow:hidden">
 ...
 <div style="position:relative;z-index:2;text-align:center;padding:0 24px;max-width:700px;margin:0 auto">
  <p style="font-size:14px;font-weight:600;letter-spacing:.32em;text-transform:uppercase;color:#6BAED6;margin-bottom:22px">Dari Alam untuk Kualitas</p>
  ...
  <div style="display:flex;align-items:center;justify-content:center;gap:14px;flex-wrap:wrap">
   <a href="{{ route('product') }}" style="display:inline-block;padding:14px 32px;font-size:11px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;border-radius:100px;background:#6BAED6;color:#0D1B2A">@lang('messages.hero_shop')</a>
...
<section style="background:#0D1B2A;padding:0">
 ...
 <div class="stat-card"><p class="serif" style="font-size:2.4rem;font-weight:700;color:#6BAED6;margin-bottom:4px">10+</p><p style="font-size:10px;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.28)">Tahun Pengalaman</p></div>
 <div class="stat-card"><p class="serif" style="font-size:2.4rem;font-weight:700;color:#6BAED6;margin-bottom:4px">50+</p><p style="font-size:10px;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.28)">Varian Produk</p></div>
 <div class="stat-card"><p class="serif" style="font-size:2.4rem;font-weight:700;color:#6BAED6;margin-bottom:4px">1K+</p><p style="font-size:10px;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.28)">Pelanggan Puas</p></div>
 <div class="stat-card"><p class="serif" style="font-size:2.4rem;font-weight:700;color:#6BAED6;margin-bottom:4px">15+</p><p style="font-size:10px;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.28)">Kota Pengiriman</p></div>
 </div>
</section>

<section style="background:#F7F9FB;padding:88px 24px">
 <div style="max-width:1100px;margin:0 auto">
 <div class="about-grid">
  <div>
   <p style="font-size:11px;font-weight:600;letter-spacing:.28em;text-transform:uppercase;color:#6BAED6;margin-bottom:14px">Tentang Kami</p>
   <h2 class="serif" style="font-size:clamp(1.8rem,4vw,2.8rem);color:#1C2B3A;font-weight:700;line-height:1.15;margin-bottom:22px">@lang('messages.master_title')</h2>
   <p style="font-size:14px;color:#4A6375;line-height:1.9;margin-bottom:14px">@lang('messages.master_p1')</p>
   <p style="font-size:14px;color:#4A6375;line-height:1.9;margin-bottom:28px">@lang('messages.master_p2')</p>
   <a href="{{ route('philosophy') }}" style="font-size:11px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:#0D1B2A;border-bottom:1.5px solid #6BAED6;padding-bottom:3px">@lang('messages.master_link') &rarr;</a>
  </div>
...
<section style="background:#EDF4F8;padding:80px 24px">
 <div style="max-width:1140px;margin:0 auto">
  <div style="text-align:center;margin-bottom:48px">
   <p style="font-size:11px;font-weight:600;letter-spacing:.28em;text-transform:uppercase;color:#6BAED6;margin-bottom:12px">@lang('messages.feat_label')</p>
   <h2 class="serif" style="font-size:clamp(1.8rem,4vw,2.6rem);color:#1C2B3A;font-weight:700;margin:0">@lang('messages.feat_title')</h2>
  </div>
  <div class="feat-grid">
  ...
  <div class="feat-card">
   ...
   <div style="padding:14px 14px 16px">
    <p style="font-weight:600;font-size:13px;color:#1C2B3A;margin-bottom:4px">{{ $product->name }}</p>
    <p style="font-size:13px;font-weight:700;color:#6BAED6;margin-bottom:12px">Rp {{ number_format($product->price,0,',','.') }}</p>
    <form method="POST" action="{{ route('cart.add') }}">@csrf
    <input type="hidden" name="product_id" value="{{ $product->id }}">
    <button type="submit" style="width:100%;font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:10px;border-radius:7px;background:#6BAED6;color:#0D1B2A;border:none;cursor:pointer">@lang('messages.add_cart')</button>
    </form>
   </div>
  </div>
  @endforeach
  ...
  <div style="text-align:center;margin-top:40px">
   <a href="{{ route('product') }}" style="display:inline-block;padding:13px 34px;font-size:11px;font-weight:600;letter-spacing:.15em;text-transform:uppercase;border-radius:100px;border:1.5px solid #0D1B2A;color:#0D1B2A">@lang('messages.feat_all') &rarr;</a>
  </div>
 </div>
</section>
...
<section style="position:relative;min-height:400px;display:flex;align-items:center;justify-content:center;overflow:hidden">
 ...
 <div style="position:relative;z-index:2;text-align:center;padding:0 24px;max-width:540px">
  <p style="font-size:11px;font-weight:600;letter-spacing:.32em;text-transform:uppercase;color:#6BAED6;margin-bottom:16px">Pesan Sekarang</p>
  ...
  <a href="{{ route('product') }}" style="display:inline-block;padding:14px 36px;font-size:11px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;border-radius:100px;background:#6BAED6;color:#0D1B2A">@lang('messages.banner_cta')</a>
 </div>
</section>
