@extends('layouts.app')
@section('title', __('messages.order_success_title'))
@section('content')
@php
...
<div style="background:#FAF8F5;min-height:80vh;display:flex;align-items:center;justify-content:center;padding:60px 20px;">
  <div style="text-align:center;max-width:560px;width:100%;">
    ...
    <h1 style="font-family:'Cormorant Garamond',serif;font-size:34px;color:#2C1810;margin-bottom:8px;"><?php echo e(__('messages.order_success_title')); ?></h1>
    ...
    <div style="background:#fff;border:1px solid #EDE5DC;border-radius:12px;padding:22px;text-align:left;margin-bottom:24px;">
      ...
      @if($order->email)<p style="font-size:12px;color:#A08070;margin-top:14px;"><?php echo e(__('messages.order_email_sent', ['email' => $order->email])); ?></p>@endif
    </div>
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
      <a href="https://wa.me/<?php echo e($waNumber); ?>?text=<?php echo e($waText); ?>" target="_blank" style="display:inline-block;background:#16a34a;color:#fff;font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;padding:14px 24px;text-decoration:none;border-radius:8px;"><?php echo e(__('messages.ask_status_whatsapp')); ?></a>
