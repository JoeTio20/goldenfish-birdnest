...
<section style="background:#F5F8F6;padding:18px 24px;border-bottom:1px solid rgba(200,168,76,.1)">
 <form method="GET" action="<?php echo e(route('product')); ?>" style="max-width:1140px;margin:0 auto;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px" class="filter-bar">
  ...
  <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
   ...
   <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" placeholder="Cari produk..." style="font-size:12px;padding:8px 12px;border-radius:8px;border:1.5px solid rgba(200,168,76,.25);background:#fff;color:#1A3D3A;outline:none;width:190px">
...
<section style="background:#F5F8F6;padding:36px 24px 72px"><div style="max-width:1140px;margin:0 auto">
 ...
 @empty <div style="grid-column:1/-1;text-align:center;padding:80px 0;color:#4A6B6B;font-size:14px">Produk tidak ditemukan.</div>@endforelse
 </div></div></section>
@endsection
