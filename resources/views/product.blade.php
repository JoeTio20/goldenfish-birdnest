...
{.prod-card{background:#fff;border-radius:14px;overflow:hidden;border:1px solid rgba(107,174,214,.12);transition:transform .2s,box-shadow .2s;cursor:default}}
...
<section style="background:#F7F9FB;padding:20px 24px;border-bottom:1px solid rgba(107,174,214,.1)">
  ...
  <div style="max-width:1140px;margin:0 auto">
    ...
    <div class="prod-card">
      <div style="position:relative;aspect-ratio:4/3;overflow:hidden;background:#EDF4F8">
        ...
        <img src="{{ $p->thumbnail }}" alt="{{ $p->name }}" style="width:100%;height:100%;object-fit:cover;transition:transform .4s" onerror="this.src='/IMAGE/SUPER.jpeg'">
      </div>
    ...
    @if($products->isEmpty())<div style="text-align:center;padding:80px 20px;color:#4A6375;font-size:14px">Belum ada produk.</div>@endif
  </div>
</section>
